...
//     return (
//         <section className="min-h-screen flex items-center justify-center bg-gradient-to-br from-background via-muted/10 to-background relative overflow-hidden">
...
//                             alt="Kathiravan"
//                             className="w-36 h-36 rounded-full mx-auto border-4 border-primary/20 shadow-2xl hover:scale-105 transition-transform duration-300"
//                         />
//                     </motion.div>
...
//                         className="text-xl md:text-3xl text-muted-foreground mb-8 text-pretty font-light"
//                     >
...
//                     >I’m a Bachelor’s student in Artificial Intelligence and Data Science with a strong passion for building intelligent,
//                         impactful software. From developing full-stack applications to experimenting with large language models, I enjoy
//                         transforming ideas into real-world solutions. With hands-on experience in AI research, problem-solving, and innovative
//                         projects, my goal is to grow as a developer and create technology that makes a difference.
//                     </motion.p>
...
//                                 variant="outline"
//                                 size="lg"
//                                 className="border-primary/40 hover:border-primary/60 bg-background text-foreground hover:bg-primary/10 transition-all duration-300 group shadow-sm"
//                             >
